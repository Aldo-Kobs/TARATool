      ...
      component: {
        ...
        externalReferences: [
          ...
          { type: 'license', url: 'https://www.gnu.org/licenses/gpl-3.0.html' },
          {
            ...
            url: 'https://kroki.io/',
            comment: en
              ? 'External render service for DOT/Graphviz (primary)'
              : 'Externer Render-Service für DOT/Graphviz (primär)',
          },
          {
            type: 'other',
            url: 'https://quickchart.io/graphviz',
            comment: en
              ? 'External render service for DOT/Graphviz (fallback)'
              : 'Externer Render-Service für DOT/Graphviz (Fallback)',
          },
        ],
      },
      manufacture: {
