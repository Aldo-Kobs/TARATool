...
(function () {
  ...
  const STRINGS = {
    de: {
      ...
      potentialMisuseCases: 'Potenzielle Fehlanwendungsfälle',
      productVariants: 'Bewertete Produktvarianten',
      assumptions: 'Annahmen',
      architectureImage: 'System- oder Produktarchitektur',
      componentsImage: 'Interne Komponenten und externe Schnittstellen',
      imageEmpty: 'Noch kein Bild hinzugefügt',
      imageInvalid: 'Bild konnte nicht eingebettet werden.',
      reportCreated: 'Report erstellt',
      mgmtSummary: 'Management-Zusammenfassung',
      mgmtIntro:
        'Diese Zusammenfassung bietet einen Management-Überblick über die aktuelle Risikoanalyse. Detaillierte Informationen (Assets, Schadensszenarien, Impact-Matrix und Angriffsbäume) folgen in den nachfolgenden Kapiteln.',
      metric: 'Kennzahl',
      value: 'Wert',
      assets: 'Assets',
      ...
      vizEmbedFail:
        'Visualisierung konnte nicht eingebettet werden (Bildkonvertierung fehlgeschlagen).',
      vizSvgFail: 'Visualisierung konnte nicht erzeugt werden (SVG-Konvertierung fehlgeschlagen).',
      vizGraphvizFail:
        'Visualisierung konnte nicht erzeugt werden (lokales Graphviz und Online-Dienste nicht verfügbar).',
      ...
      colMeasure: 'Detaillierte Kontrollmaßnahme',
      requirementLink: 'Link zur Anforderung',
      colRemark: 'Anmerkung',
      residualTree: 'Restrisiko-Baum',
      toastRrTree: 'Erzeuge Restrisiko-Baum (SVG)…',
      rrVizEmbedFail:
        'Restrisiko-Visualisierung konnte nicht eingebettet werden (Bildkonvertierung fehlgeschlagen).',
      rrVizSvgFail:
        'Restrisiko-Visualisierung konnte nicht erzeugt werden (SVG-Konvertierung fehlgeschlagen).',
      rrVizGraphvizFail:
        'Restrisiko-Visualisierung konnte nicht erzeugt werden (lokales Graphviz und Online-Dienste nicht verfügbar).',
      approval: 'Freigabe',
      ...
      distLine: (d) =>
        `Kritisch: ${d.Kritisch} | Hoch: ${d.Hoch} | Mittel: ${d.Mittel} | Niedrig: ${d.Niedrig} | Unbekannt: ${d.Unbekannt}`,
    },
    en: {
      ...
      functions: 'Functions',
      potentialMisuseCases: 'Potential misuse cases',
      productVariants: 'Product variants evaluated',
      assumptions: 'Assumptions',
      architectureImage: 'System or product architecture',
      componentsImage: 'Internal components and external interfaces',
      imageEmpty: 'No image added yet',
      imageInvalid: 'Image could not be embedded.',
      reportCreated: 'Report generated',
      mgmtSummary: 'Management summary',
      mgmtIntro:
        'This summary provides a management overview of the current risk analysis. Detailed information (assets, damage scenarios, impact matrix and attack trees) follows in subsequent chapters.',
      metric: 'Metric',
      value: 'Value',
      assets: 'Assets',
      ...
      vizGraphvizFail:
        'Visualisation could not be created (local Graphviz and online services unavailable).',
      ...
      colMeasure: 'Detailed Control Measure',
      requirementLink: 'Link to requirement',
      colRemark: 'Remark',
      residualTree: 'Residual risk tree',
      toastRrTree: 'Generating residual risk tree (SVG)…',
      rrVizEmbedFail:
        'Residual risk visualisation could not be embedded (image conversion failed).',
      rrVizSvgFail: 'Residual risk visualisation could not be created (SVG conversion failed).',
      rrVizGraphvizFail:
        'Residual risk visualisation could not be created (local Graphviz and online services unavailable).',
      approval: 'Approval',
      ...
      distLine: (d) =>
        `Critical: ${d.Kritisch} | High: ${d.Hoch} | Medium: ${d.Mittel} | Low: ${d.Niedrig} | Unknown: ${d.Unbekannt}`,
    },
  };
